      ...
      type, public, extends(ChandDR) :: ScatPhoton_KN
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
      ...
      call this%Get_Scattered_Phot4k_CF(k_p, mu_kp_pe_CF)
...
!*******************************************************************************************************
      subroutine Get_Scattered_Phot4k_CF_Sub(this, k_p, mu_kp_pe_CF1)
!*******************************************************************************************************
      implicit none
      class(ScatPhoton_KN) :: this 
      real(mcp), intent(in) :: k_p(1: 3)
      real(mcp), intent(out) :: mu_kp_pe_CF1
      ...
      mu_kp_pe_CF1 = mu_kp_pe_CF

      !Scattered_Phot4k_In_Elec(1) = this%Elec_gama * this%Scattered_Phot4k_In_Elec_CF(1) * ( one + &
      !                                   this%Elec_V * Temp_Matrix_1X3(3) )

      !this%nu_vs_nup = this%Elec_gama * ( one + this%Elec_V * Temp_Matrix_1X3(3) )

      Scattered_Phot4k_In_Elec(1) = this%Scattered_Phot4k_In_Elec_CF(1) * &
                           this%Elec_gama * ( one + this%Elec_V * Temp_Matrix_1X3(3) )
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
      ...
      if( mu_ya_yb > zero .and. dabs(mu_ya_yb-one) <= 1.D-8 .or. mu_ya_yb > one )then
          Rot_angle_k_Pe = zero!- dsign(one, mu_signs) * dacos( mu_ya_yb )
      ...
      !if( isnan( Rot_angle_k_Pe ) )then
      !    write(*, *)'mmsf0=', Rot_angle_k_Pe, mu_signs, mu_ya_yb, k_p 
      !    write(*, *)'mmsf4=', this%Scat_Phot_AxisY, this%Scat_Phot_AxisX
      !    write(*, *)'mmsf5=', this%Scat_Phot_Pe_AxisY, this%Scat_Phot_Pe_AxisX 
      ! endif
      ...
      !write(*, fmt="(' ', A5, 2ES18.7)")'s3=', Vector3D_Inner_Product( this%f4_scat_CF(2:4), &
        ! this%Scat_Phot3k_CF), Vector3D_Length( this%Scat_Phot3k_CF )
...
!*******************************************************************************************************
      ...
      real(mcp) :: N_temp, Vector_Length, nup_vs_nu
      real(mcp), dimension(1:4) :: Scattered_Phot4k_In_Elec
      ...
      real(mcp) :: psi_pp, beta, mu_kp_pe_CF, factor, Trans_factor
      real(mcp) :: a, b, c
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
      call this%Get_Scattered_Phot4k_CF( k_p, mu_kp_pe_CF )
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 
      !factor = one - mu_kp_pe_CF * this%Elec_v
      !Trans_factor = (nup_vs_nu / this%Elec_gama / factor)**2

      N_temp = F0 + F1 * ( Q_xi * dcos( two*phi1 ) + U_xi * dsin( two*phi1 ) )
      this%Vector_Stokes4_ECF_scat(1) = this%Vector_Stokes4_ECF(1)
      this%Vector_Stokes4_ECF_scat(2) = ( F1 + F11 * ( Q_xi * dcos( two*phi1 ) + &
                     U_xi * dsin( two*phi1 ) ) ) * this%Vector_Stokes4_ECF(1) / N_temp
      this%Vector_Stokes4_ECF_scat(3) =  F22 * ( - Q_xi * dsin( two*phi1 ) + &
                     U_xi * dcos( two*phi1 ) ) * this%Vector_Stokes4_ECF(1) / N_temp 
      this%Vector_Stokes4_ECF_scat(4) =  F33 * this%Vector_Stokes4_ECF(4) / N_temp

      !this%Vector_Stokes4_ECF_scat = this%Vector_Stokes4_ECF_scat * Trans_factor
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~   
      call this%Get_Scattered_Stokes_Vector_And_f_CF( k_p )
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 
