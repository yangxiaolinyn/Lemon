    ...
    real(mcp) :: mu_esti(1: 2), sin_esti(1: 2), Terminate_Tolerence
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    ...
    y_obs2 = 1.D0   ! where y_obs1 and y_obs2 determine the range of observational frequency. 
    TerminateTime = 5 ! The Number of scattering times to terminate the scattering sequence.
    Terminate_Tolerence = 1.D-30 ! The Tolerence value to terminate the scattering sequence.
