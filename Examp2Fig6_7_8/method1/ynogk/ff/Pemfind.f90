...
!*******************************************************************************        
      ...
      contains
!******************************************************************************
      subroutine pemfinds(f1234,lambda,q,sinobs,muobs,a_spin,robs,scal,rin,rout,muup,mudown,&
                       phy1,phy2,caserange,Fp,paras,orir,oricosth,bisection,NN,pemfind)
!******************************************************************************
                ...
                If(caserange.eq.1 .or.caserange.eq.3)then
                    ...
                    (phy1-phya1)*(phy1-phya2).lt.zero.or.(phy2-phya1)*(phy2-phya2).lt.zero)then
                        Sectionp=rootfind(f1234,lambda,q,sinobs,muobs,a_spin,robs,scal,t1,t2,p1,p2,NN,Fp,&
                                   paras,orir,oricosth,bisection) !(0,1)
                    else 
...
!write(unit=6,fmt=*)'fc=',f1,f2,fc
        counter=0
        Do while(dabs(p2-p1)/p1.gt.1.D-4)
...
!*****************************************************************************************************
      Function NewRapson(f1234,lambda,q,sinobs,muobs,a_spin,robs,scal,&
                           t1,t2,p1,p2,Fp,paras,orir,oricosth)
!*****************************************************************************************************
