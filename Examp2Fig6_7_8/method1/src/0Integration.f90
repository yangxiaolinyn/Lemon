      ...
      real(mcp) :: x30(0: 6), w30(0: 6), x40(0: 9), w40(0: 9), x60(0: 19), w60(0: 19)
      real(mcp) :: x70(0: 6), w70(0: 6), x80(0: 9), w80(0: 9), x90(0: 19), w90(0: 19)
      ...
      real(mcp) :: x0lag1000(0: 999), w0lag1000(0: 999)
      real(mcp), allocatable :: IntegArrayx(:), IntegArrayw(:)
      integer, allocatable :: Ninteg
...
!*******************************************************************
      ...
      call gauleg_x_w( -one, one, x30,   w30,   30 )
      call gauleg_x_w( -one, one, x40,   w40,   40 )
      call gauleg_x_w( -one, one, x50,   w50,   50 )
      call gauleg_x_w( -one, one, x60,   w60,   60 )
      call gauleg_x_w( -one, one, x90,   w90,   90 )
      call gauleg_x_w( -one, one, x70,   w70,   70 )
      call gauleg_x_w( -one, one, x80,   w80,   80 )
...
!*******************************************************************************************************
      ...
      integer :: i, its, j
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
! Given alf , the parameter α of the Laguerre polynomials, this routine returns arrays x and w
...
! I = \int^\infty_0 x^alf * exp(-x) * f(x) dx = \Sum_{j=0}^{j=n-1} w_i * f(x_i)
!*******************************************************************************************************
