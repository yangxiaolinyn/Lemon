      ...
      ns = 500
;~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
      Openr,lunAo10,'./vLv_finity_tau=00004.txt',/Get_Lun
      Point_lun,lunAo10,0
      lv=fltarr(ns)
      ReadF,lunAo10,lv
      free_lun,lunAo10
...
;~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
      ...
      axis,yaxis=1,ytickname=replicate(' ',12),yticks=10,yminor=2
      dyy = 0.35
      y0 = 5
      for i=0,0 do begin
          ;oplot,vv(*),alog10(lv(*) /max(lv) ),thick=5,color=black,linestyle=1;,psym=-4
          oplot,vv(*),alog10(lv2(*) /max(lv2)),thick=2,color=black,linestyle=6;,psym=-4
