...
;~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~  
      rdfile, infile = './dataPowerlaw_alp=3.0000.dat', mu = 1, times = 4, IQUV_2, ns 
;~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 
...
;~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~  
      ...
      rdfil, infile = './BCS_Powerlaw_alp=3.0000.dat', I0, Q0, U0, V0, ns
      ;print, I0(*)
      ;I0(0, 200:*) = 0.
      ;I0(1, 200:*) = 0.
      ;I0(2, 200:*) = 0.
      ...
      for j=0, n_x-1 do begin    
        for i=0, n_y-1 do begin    
          ...
          IF (i EQ 0) and (j EQ 0) THEN BEGIN 
            ...
            xyouts, 1.1, -0.8,  textoidl('S_{in} = (1, 0.25, 0.433, 0.866)'), charsize=1.6
