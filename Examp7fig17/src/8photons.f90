...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
      SUBROUTINE Set_initial_parameter_values_Sub( this, tau, mu0, phi0, &
                        I0, Q0, U0, V0, phi_esti, Num_phi_esti )
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
      IMPLICIT NONE  
      class(Photons) :: this   
      !TYPE(Photon_Emitter), INTENT(INOUT) :: Emitter 
      REAL(mcp), INTENT(IN) :: tau, mu0, phi0, I0, Q0, U0, V0, &
                    phi_esti(1: Num_phi_esti)
      integer, intent(in) :: Num_phi_esti
      integer :: i, ierr
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
      ...
      !enddo 
      this%phi_esti(1: Num_phi_esti) = phi_esti
      this%N_phi_esti = Num_phi_esti
       
      allocate( this%IQUV_Emerg(1: 4, 0: Num_mu, 1: 2, 1: Num_phi_esti), stat = ierr )
