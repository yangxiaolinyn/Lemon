...
!**************************************************************************************
    SUBROUTINE mimick_of_ph_Slab_BoundReflc( Total_Phot_Num, &
                        tau, T_bb, T_elec, CrossSec_filename )
!************************************************************************************** 
    implicit none 
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 
    ...
    if( myid == np-1 )then
        ...
        do i1 = 1, 8
            ...
            do k1 = 0, vL_sc_up
                Es = k1 * phot%dy
                call phot%Hxm_alaytical_results( E0, Es, mu2, g1Emu2 )
                Imu_Recv(i1, 1, k1) = g1Emu2
            enddo
        enddo 
        open(unit=10, file='./spectrum/HxmImu1.txt', status="replace") 
        do j = 0, vL_sc_up 
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 
        ...
        !~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 
            ...
            CALL phot%Determine_P_Of_Scatt_Site_And_Quantities_At_p() 
            !if( phot%Phot4k_CtrCF_ini(1) < 120.D-6 .or. phot%w_ini <= 1.D-1)exit
            !~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~      
