...
!**********************************************************************
      ...
      e_p(2) = zero
      e_p(3) = one
      call this%Vector_Cross_Product( e_p, this%PhotAxisZ, this%PhotAxisX )
...
!*******************************************************************************************************
      ...
      this%Scattered_Phot4k_CF(2) = this%Scattered_Phot4k_CF(1) * sinpsi * dcos( phip )
      this%Scattered_Phot4k_CF(3) = this%Scattered_Phot4k_CF(1) * sinpsi * dsin( phip )
      this%Scattered_Phot4k_CF(4) = this%Scattered_Phot4k_CF(1) * mupsi
      this%Scattered_Phot4k_CovCF = this%Scattered_Phot4k_CF
      this%Scattered_Phot4k_CovCF(1) = - this%Scattered_Phot4k_CF(1)
      if ( isnan( this%Scattered_Phot4k_CF(1) ) ) write(*,*)'sdfsdf1===',this%Scattered_Phot4k_CF(1)
      if ( isnan( this%Scattered_Phot4k_CF(2) ) ) write(*,*)'sdfsdf2===',this%Scattered_Phot4k_CF(2)
