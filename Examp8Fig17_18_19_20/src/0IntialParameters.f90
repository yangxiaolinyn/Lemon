    ...
    integer, parameter :: vL_sc_up = 400
    integer, parameter :: Num_PolDeg = 50
    integer, parameter :: Num_Phi = 100
    integer, parameter :: Num_mu = 4
    integer, parameter :: Num_J_tau_z = 1
    integer, parameter :: Num_J_tau_the = 1
    integer, parameter :: Num_J_tau_phi = 1
    integer, parameter :: N_esti_phi = Num_Phi
    real(mcp), parameter :: half_re2 = 3.D0 / 16.D0 / pi
