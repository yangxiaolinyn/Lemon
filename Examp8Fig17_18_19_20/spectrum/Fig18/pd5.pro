...
;~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~   
      ...
      readfile1, infile = './dataTe=8.125E-01tau=1.000E-02.dat', I_mu_6, ns
      ;print, I0(0, *)
     ; I0(0, 200:*) = 0.
     ; I0(1, 200:*) = 0.
     ; I0(2, 200:*) = 0.
...
;~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~   
      ...
      !p.font = 0
      device,filename='./fig_5.ps',xsize=xxss,ysize=yyss,bits_per_pixel=8,$
      ...
      for i=0,m-1 do begin    
         ...
         nt = 1000 * 5.99 / 6
          ...
          IF i EQ 0 THEN BEGIN
              ...
              dy = 0.5
              xyouts, 3.3, -0.9, textoidl('\Theta = 1.59'), charsize=1.8
              xyouts, 3.3, -0.9 - dy, textoidl('\tau = 0.01'), charsize=1.8
              xyouts, 3.3, -0.9 - 2*dy, textoidl('\mu = 0.1'), charsize=1.8
          ...
          IF i EQ 1 THEN BEGIN
              ...
              xyouts, 3.3, -0.9 - 2*dy, textoidl('\mu = 0.5'), charsize=1.8
