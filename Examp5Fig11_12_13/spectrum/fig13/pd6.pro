...
;~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~  
      ;readfile, infile = './IQUV0_mu0=08_nozeroQUV.txt', IQUV_I0, IQUV_Q0, IQUV_U0, IQUV_V0, nf 
;~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~  
      readfile, infile = './IQUVphi=90_mu0=-0.8000.dat', IQUV_I90, IQUV_Q90, IQUV_U90, IQUV_V90, nf 
...
;~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~  
      ;readfile, infile = './IQUV180_mu0=08_nozeroQUV.txt', IQUV_I180, IQUV_Q180, IQUV_U180, IQUV_V180, nf 
;~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~  
      readfile, infile = './IQUVphi=0180_mu0=-0.8000.dat', I_0_180, Q_0_180, U_0_180, V_0_180, nf 
...
;~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~    
     ;print, Irlu_theta
      ...
      axis,yaxis=0,ytitle=textoidl('Intensity'),yticks=6,yminor=2,yrange=[ylow,yup],ystyle=1,charsize=csize
      axis,yaxis=1,ytickname=replicate(' ',12),yticks=6,yminor=2,charsize=csize
      dyy = 0.35
      y0 = 5
      rat = 1.0
      theta0 = acos(0.8)
      ...
      for i=0,0 do begin    
          ...
          oplot, Irlu_theta0_180,  Irluv_v*0.5+0.3, thick=1, color=black, linestyle=6;,psym=-4  
          ...
          oplot, Irlu_theta0180,  V_0_180*num_scale_v*0.5+0.3, thick=5, color=black, linestyle=1;,psym=-4  
          ...
          xyouts, Irlu_theta0_180[nf/2], -Irluv_q[nf/2]+0.029 , 'Q',charsize=csize
          xyouts, Irlu_theta0_180[nf/2], Irluv_u[nf/2]+0.021 , 'U',charsize=csize
          xyouts, Irlu_theta0_180[nf/2], Irluv_v[nf/2]*0.1+0.3+0.015 , 'V',charsize=csize

          xline = fltarr(100)
          xline(*) =  acos(0.8)*180/!pi - 90.0
          yline = fltarr(100)
          for i=0, 99 do begin
...
;~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
      ...
      axis,yaxis=0,ytickname=replicate(' ',12),yticks=6,yminor=2,charsize=csize
      ;axis,yaxis=1,ytickname=replicate(' ',12),yticks=7,yminor=2
      axis,yaxis=1,ytitle=textoidl('Intensity'),yticks=6,yminor=2,yrange=[ylow,yup],ystyle=1,charsize=csize
...
;~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 
          ...
          ;x;youts,  68., 0.4 , 'U'
          print, nf1
          xyouts, theta90(nf1/2), Irluv_I90(nf1/2)+0.02 , 'I',charsize=csize
          xyouts, theta90(nf1/2), Irluv_q90(nf1/2)+0.02 , 'Q',charsize=csize
          xyouts, 30, -Irluv_u90(60)+0.01 , 'V',charsize=csize
          xyouts, 30, -Irluv_v90(60)+0.02 , 'U',charsize=csize
;~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
