...
;~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~  
;~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~   
      readfile, infile = './ChandraIQUV_phi_mu0=-0.8000.dat', m=4, Ichd, Qchd, Uchd, Vchd, nf
;~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 
...
;~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~   
;~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~  
      readfile, infile = './IQUVphi_mu0=-0.8000.dat', m=4, Imc, Qmc, Umc, Vmc, nf 
;~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~  
...
;~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 
      ...
      !p.font = 0
      device,filename='./fig14_8.ps',xsize=xxss,ysize=yyss,bits_per_pixel=8,$
      ...
      for i=0,3 do begin    
         ...
         ;axis,xaxis=0,xticks=6,xminor=4,xrange=[xlow,xup],xstyle=1,$;font=-1,$;,xtickname=replicate(' ',6),$;,
          ...
          IF i EQ 2 THEN BEGIN
              axis,yaxis=0,ytitle=textoidl('U'),yticks=4,yminor=2,yrange=[ylow,yup],ystyle=1
              axis,yaxis=1,ytickname=replicate(' ',12),yticks=4,yminor=2
              axis,xaxis=1,xticks=5,xminor=4,xtickname=replicate(' ',15)
              axis,xaxis=0,xticks=5,xminor=4,xtickname=replicate(' ',15)
