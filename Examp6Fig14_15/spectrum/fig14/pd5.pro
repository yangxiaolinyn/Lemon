...
;~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~  
;~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~   
      readfile, infile = './ChandraIQUV_phi_mu0=-0.2000.dat', m=4, Ichd, Qchd, Uchd, Vchd, nf
;~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 
...
;~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~   
;~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~  
      readfile, infile = './IQUVphi_mu0=-0.2000.dat', m=4, Imc, Qmc, Umc, Vmc, nf 
;~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~  
...
;~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 
      ...
      for i=0,3 do begin    
         ...
         ;axis,xaxis=0,xticks=6,xminor=4,xrange=[xlow,xup],xstyle=1,$;font=-1,$;,xtickname=replicate(' ',6),$;,
          ...
          IF i EQ 0 THEN BEGIN
              axis,yaxis=0,ytitle=textoidl('I'),yticks=4,yminor=2,yrange=[ylow,yup],ystyle=1
          ...
          IF i EQ 1 THEN BEGIN
              axis,yaxis=0,ytitle=textoidl('Q'),yticks=3,yminor=2,yrange=[ylow,yup],ystyle=1
              axis,yaxis=1,ytickname=replicate(' ',12),yticks=3,yminor=2
          ...
          IF i EQ 2 THEN BEGIN
              axis,yaxis=0,ytitle=textoidl('U'),yticks=3,yminor=2,yrange=[ylow,yup],ystyle=1
              axis,yaxis=1,ytickname=replicate(' ',12),yticks=3,yminor=2
              axis,xaxis=1,xticks=5,xminor=4,xtickname=replicate(' ',15)
              axis,xaxis=0,xticks=5,xminor=4,xtickname=replicate(' ',15)
