...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~  
          ...
          procedure, public :: Get_scatter_distance_BoundReflec2
          procedure, public :: Get_scatter_distance_BoundReflec_new
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
      ...
      contains   
!*******************************************************************************************************
      real(mcp) function Get_scatter_distance_BoundReflec_new( this )
!*******************************************************************************************************
      implicit none
      ...
      if( this%Vector_of_Momentum_ini(3) > zero )then
          ...
          if( this%z_tau > 1.D-15 )then
              ...
              Get_scatter_distance_BoundReflec_new = this%z_tau + delta_z
              if(Get_scatter_distance_BoundReflec_new < zero)then
                  this%NormalA = one
                  Get_scatter_distance_BoundReflec_new = zero
              endif
          else
              this%NormalA = one   
              Get_scatter_distance_BoundReflec_new = this%z_tau 
          endif
          ...
          this%p_reflect = dexp( - p_out1 )
          !r1 = ranmar()
          if( ranmar() <= this%p_reflect )then
              this%InterSection_Cases = 2
              !Get_scatter_distance_BoundReflec_new = this%z_tau + ranmar() * ( this%z_max - this%z_tau )
              !this%NormalA = ( this%z_max - this%z_tau )
              this%NormalA = one
              Get_scatter_distance_BoundReflec_new = this%z_max
          else
              this%InterSection_Cases = 3
              this%NormalA = one - this%p_reflect
              eta = - dlog( one - ranmar() * this%NormalA )  
              delta_z = - eta * this%Vector_of_Momentum_ini(3) / this%ne_times_Sigma_a
              Get_scatter_distance_BoundReflec_new = this%z_tau + delta_z 
              this%NormalA = one
          endif
      ...
      if( isnan(Get_scatter_distance_BoundReflec_new) ) then
           write(*,*)'ends=', this%medium_case, Get_scatter_distance_BoundReflec_new, r1, this%NormalA,  &
             this%InterSection_Cases, p_out1, this%z_tau, this%Vector_of_Momentum_ini
           stop
      endif 
  
      if( this%test_it )then
          write(*,*)'sdf2==', r1, this%NormalA, Get_scatter_distance_BoundReflec_new, p_out1
      endif
      If (Get_scatter_distance_BoundReflec_new < zero) then
         write(*,*)'sdf==',Get_scatter_distance_BoundReflec_new, p_out1 , this%Z_max, this%z_ini, &
              this%Vector_of_Momentum_ini(3), this%InterSection_Cases, dlog( one - r1 * this%NormalA ), &
               this%NormalA, r1, this%z_tau
          stop
      endif
      if(p_out1 < zero )then
          write(*,*)'sdf123==',Get_scatter_distance_BoundReflec_new, &
                   this%InterSection_Cases, p_out1, this%z_ini,&
           this%Vector_of_Momentum_ini(3), this%NormalA, this%medium_case
           write(*, *)'ffs=', this%Z_max, this%z_tau, this%Vector_of_Momentum_ini(3), this%ne_times_Sigma_a
          stop
       endif 
      !~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 
      !If (Get_scatter_distance_BoundReflec_new == zero) then
          !write(*,*)'endsf=', this%medium_case, Get_scatter_distance_BoundReflec_new, r1, this%NormalA,  &
          !   this%InterSection_Cases, p_out1, this%z_tau, this%Vector_of_Momentum_ini
          !stop
      !endif
      return 
      end function Get_scatter_distance_BoundReflec_new
!******************************************************************************************************* 
      ...
      if( this%Vector_of_Momentum_ini(3) > zero )then
          ...
          if( this%z_tau > 1.D-15 )then
              ...
              if(Get_scatter_distance_BoundReflec < zero)then
                  this%NormalA = one
                  Get_scatter_distance_BoundReflec = zero
              endif
          else
              this%NormalA = one   
          ...
          this%InterSection_Cases = 2  
          p_out1 = -( this%z_max - this%z_tau ) / this%Vector_of_Momentum_ini(3) * this%ne_times_Sigma_a 
          !tau1 = - ( this%z_max - this%z_tau ) / this%Vector_of_Momentum_ini(3) * this%ne_times_Sigma_a 
          eta = - dlog( one - ranmar() )
          if(eta <= p_out1)then
              ...
              !delta_z = dlog( one - r1 * this%NormalA ) * this%Vector_of_Momentum_ini(3) / &
              !         this%ne_times_Sigma_a
              delta_z = - eta * this%Vector_of_Momentum_ini(3) / &
                       this%ne_times_Sigma_a
              Get_scatter_distance_BoundReflec = this%z_tau + delta_z
              !write(*,*)'sdf==',this%NormalA, p_out1, delta_z
          else 
              this%NormalA = one
              Get_scatter_distance_BoundReflec = this%z_max * 10.D0
              !write(*,*)'sdf1111==', p_out1
              !stop
          endif
          !if( this%E_ini <= 1.D-2 )then
          !    this%CROS_absorption = dabs( delta_z ) * this%n_e1 * PhotoElect_CSect( this%E_ini )
...
!*******************************************************************************************************
      real(mcp) function Get_scatter_distance_BoundReflec2( this )
!*******************************************************************************************************
      implicit none
      class(Photon_With_ScatDistance_FlatSP) :: this
      !real(mcp), intent(in) :: T_e1  
      ...
      if( this%Vector_of_Momentum_ini(3) > zero )then
          ...
          if( this%z_tau > 1.D-15 )then
              ...
              delta_z = dlog( one - r1 * this%NormalA ) * this%Vector_of_Momentum_ini(3) / &
                            this%ne_times_Sigma_a
              Get_scatter_distance_BoundReflec2 = this%z_tau + delta_z
              if(Get_scatter_distance_BoundReflec2 < zero)then
                  this%NormalA = one
                  Get_scatter_distance_BoundReflec2 = zero
              endif
          else
              this%NormalA = one   
              Get_scatter_distance_BoundReflec2 = this%z_tau 
          endif
          !if( this%E_ini <= 1.D-2 )then
          !    this%CROS_absorption = dabs( delta_z ) * this%n_e1 * PhotoElect_CSect( this%E_ini )
          !else
          ...
          !else 
              !this%NormalA = one
              !Get_scatter_distance_BoundReflec2 = this%z_max * 10.D0
              !write(*,*)'sdf1111==', p_out1
              !stop
          !endif
          !if( this%E_ini <= 1.D-2 )then
      ...
      if( isnan(Get_scatter_distance_BoundReflec2) ) then
           write(*,*)'ends=', this%medium_case, Get_scatter_distance_BoundReflec2, r1, this%NormalA,  &
             this%InterSection_Cases, p_out1, this%z_tau, this%Vector_of_Momentum_ini
           stop
      endif 
  
      if( this%test_it )then
          write(*,*)'sdf2==', r1, this%NormalA, Get_scatter_distance_BoundReflec2, p_out1
      endif
      If (Get_scatter_distance_BoundReflec2 < zero) then
         write(*,*)'sdf==',Get_scatter_distance_BoundReflec2, p_out1 , this%Z_max, this%z_ini, &
              this%Vector_of_Momentum_ini(3), this%InterSection_Cases, dlog( one - r1 * this%NormalA ), &
               this%NormalA, r1, this%z_tau
          stop
      endif
      if(p_out1 < zero )then
          write(*,*)'sdf123==',Get_scatter_distance_BoundReflec2, this%InterSection_Cases, p_out1, this%z_ini,&
           this%Vector_of_Momentum_ini(3), this%NormalA, this%medium_case
           write(*, *)'ffs=', this%Z_max, this%z_tau, this%Vector_of_Momentum_ini(3), this%ne_times_Sigma_a
          stop
       endif 
      !~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 
      !If (Get_scatter_distance_BoundReflec2 == zero) then
          !write(*,*)'endsf=', this%medium_case, Get_scatter_distance_BoundReflec2, r1, this%NormalA,  &
          !   this%InterSection_Cases, p_out1, this%z_tau, this%Vector_of_Momentum_ini
          !stop
      !endif
      return 
      end function Get_scatter_distance_BoundReflec2
!******************************************************************************************************* 
...
!*******************************************************************************************************
      ...
      write(*,*)'crossection=', this%logE_up, this%logE_low, this%CrossSectFileName
      !stop
